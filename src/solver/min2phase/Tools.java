...
public class Tools {
     ...
     *
     * @see solver.min2phase.Tools#saveTo(java.io.DataOutput)
     */
     ...
     *
     * @see solver.min2phase.Tools#initFrom(java.io.DataInput)
     */
     ...
     *
     * The random source can be set by {@link solver.min2phase.Tools#setRandomSource(java.util.Random)}
     *
     ...
     *
     * @see solver.min2phase.Tools#setRandomSource(java.util.Random)
     * @see solver.min2phase.Search#solution(java.lang.String facelets, int maxDepth, long timeOut, long timeMin, int verbose)
     */
     ...
     *
     * @param facelets is the cube definition string , see {@link solver.min2phase.Search#solution(java.lang.String facelets, int maxDepth, long timeOut, long timeMin, int verbose)}
