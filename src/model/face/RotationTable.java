...
public class RotationTable {
    ...
    static {
        table.put("FRONT_true", new RotationMapping(Direction.FRONT, false, new EdgeMapping[]{ //
        ...
        table.put("FRONT_false", new RotationMapping(Direction.FRONT, true, new EdgeMapping[]{ //
